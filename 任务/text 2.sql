...
CREATE TABLE `assess`  (
  ...
  `ass_id` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评价所对应的id',
...
-- Records of assess
-- ----------------------------
INSERT INTO `assess` VALUES (1, '1', '非常高');
INSERT INTO `assess` VALUES (2, '2', '较高');
INSERT INTO `assess` VALUES (3, '3', '一般');
INSERT INTO `assess` VALUES (4, '4', '较低');
INSERT INTO `assess` VALUES (5, '5', '非常低');
...
CREATE TABLE `course_assess`  (
  ...
  `cou_id` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程所对应的id',
  `ass_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评价所对应的id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `evaluate`  (
  ...
  `eva_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分所对应的id',
...
-- Records of evaluate
-- ----------------------------
INSERT INTO `evaluate` VALUES (1, '1', '完全达到');
INSERT INTO `evaluate` VALUES (2, '2', '达到');
INSERT INTO `evaluate` VALUES (3, '3', '基本达到');
INSERT INTO `evaluate` VALUES (4, '4', '基本未达到');
INSERT INTO `evaluate` VALUES (5, '5', '完全未达到');
...
CREATE TABLE `requirementsmall`  (
  ...
  `req_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '毕业要求小项所对应的id',
...
-- ----------------------------
-- Table structure for requiresmall_evaluate
-- ----------------------------
DROP TABLE IF EXISTS `requiresmall_evaluate`;
CREATE TABLE `requiresmall_evaluate`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `stu_id` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学号',
  `req_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '毕业要求小项所对应的id',
  `eva_id` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '毕业要求评价所对应的id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `student`  (
  ...
  `work` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否就业',
  ...
  `wnature` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位性质',
  `windustry` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '工作行业',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `student_discipline`  (
  ...
  `dis_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程所对应的id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for student_requirement
-- ----------------------------
DROP TABLE IF EXISTS `student_requirement`;
CREATE TABLE `student_requirement`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '个人与学科要求的关联表',
  `stu_id` int(0) NULL DEFAULT NULL COMMENT '学生的学号',
  `require_id` int(0) NULL DEFAULT NULL COMMENT '毕业要求大项所对应的内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
